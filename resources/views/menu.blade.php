...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/images/favicon-96x96.png') }}" type="image/x-icon">
    <link rel="icon" href="{{ asset('assets/images/web-app-manifest-192x192.png') }}" type="image/x-icon">
    <link rel="icon" href="{{ asset('assets/images/web-app-manifest-512x512.png') }}" type="image/x-icon">
...
<body>
    ...
    <div class="page">
                    ...
                    <li class="header-element dropdown">
                        ...
                        <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                            ...
                            <li><a class="dropdown-item d-flex align-items-center" href="{{ route('logout') }}"
                                    ...
                                    <i class="fe fe-lock p-1 rounded-circle bg-primary-transparent ut me-2 fs-16"></i>
        ...
        <aside class="app-sidebar sticky" id="sidebar">
            ...
            <div class="main-sidebar-header" id="sidebarHeader">
                {{-- <img src="{{ asset('assets/images/logo_ista.png') }}" alt="logo" class="desktop-logo"
                    width="100px"> --}}
            </div>
            ...
            <div class="main-sidebar" id="sidebar-scroll">
                ...
                <nav class="main-menu-container nav nav-pills flex-column sub-open">
                    ...
                    <ul class="main-menu">
                        ...
                        @can('menu transacciones')
                            ...
                            <li class="slide has-sub" id="administracionMenu">
                                <a href="javascript:void(0);" class="side-menu__item">
                                    ...
                                    <span class="side-menu__label">Transacciones</span>
                                    <i class="ri-arrow-down-s-line side-menu__angle"></i>
                                </a>
                                <ul class="slide-menu child1">
                                    <li class="slide side-menu__label1">
                                    ...
                                    @can('caja read')
                                        <li class="slide">
                                            <a href="{{ url('ingreso_diario') }}" id="ingresoDiarioOption"
                                                class="side-menu__item">Caja</a>
                                        </li>
                                    @endcan
                                    ...
                                    @can('recibo read')
                                        <li class="slide">
                                            <a href="{{ url('recibo') }}" id="reciboOption"
                                                class="side-menu__item">Recibo</a>
                                        </li>
                                    @endcan
                        ...
                        @can('menu reportes')
                            ...
                            <li class="slide has-sub" id="reportesMenu">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide">
                                        <a href="{{ route('reportes.corte_caja') }}" id="reporteCorteCajaOption"
                                            class="side-menu__item">Corte de caja</a>
                                    </li>

                                    <li class="slide">
                                        <a href="{{ route('reportes.codigo_ingreso') }}" id="reportecodigoIngresoOption"
                                            class="side-menu__item">Consolidado por codigo de ingreso</a>
                                    </li>
                                    <li class="slide">
                                        <a href="{{ route('reportes.ingreso_cuenta_bancaria') }}"
                                            id="reporteIngresoCuentaOption" class="side-menu__item">Ingresos por cuenta
                                            bancaria</a>
                                    </li>

                                    <li class="slide">
                                        <a href="{{ route('reportes.ingreso_periodo') }}"
                                            id="reportePeriodoOption" class="side-menu__item">Ingresos por
                                            Período</a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        @can('menu creditos')
                            <li class="slide has-sub" id="creditosMenu">
                                <a href="javascript:void(0);" class="side-menu__item">
                                    ...
                                    <span class="side-menu__label">Créditos</span>
                                    <i class="ri-arrow-down-s-line side-menu__angle"></i>
                                </a>
                                <ul class="slide-menu child1">
                                    <li class="slide">
                                        <a href="{{ url('estado_cuenta') }}" id="estadoCuentaOption" target="_blank"
                                            class="side-menu__item">Estado de cuenta</a>
                                    </li>
    ...
    <script>
        ...
        function updateSidebarUI() {
            ...
            if (sidebarExpanded) {
                sidebarHeader.style.display = 'flex'; // 👈 mantener centrado
            } else {
        ...
        setInterval(() => {
            fetch("{{ route('home') }}", {
                ...
                .then(response => {
                    // Si Laravel redirige al login, la URL final contiene '/login'
