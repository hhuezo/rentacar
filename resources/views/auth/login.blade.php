...
@section('content')
    ...
    <link id="style" href="{{ asset('assets/css/google-font.css') }}" rel="stylesheet">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="text-blue-700 size-8">
                            <svg fill="none" viewBox="0 0 48 48">
                                <path
                                    d="M24 4C25.7 14.2 33.8 22.2 44 24C33.8 25.8 25.7 33.8 24 44C22.2 33.8 14.2 25.7 4 24C14.2 22.2 22.2 14.2 24 4Z"
                                    fill="currentColor" />
                            </svg>
                        </div>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="w-full flex flex-col gap-4 px-4">
                        ...
                        <label class="flex flex-col w-full">
                            <div class="flex justify-between items-center pb-2">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="text-blue-700 text-sm font-medium hover:underline"
                        ...
                        <label class="flex items-center gap-2 mt-2">
                            <input type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}
                                class="rounded border-gray-300 text-blue-700 h-4 w-4">
                            <span class="text-gray-700 text-sm">Recordarme</span>
                        </label>

                        <!-- Submit -->
                        <button
                            class="mt-4 flex items-center justify-center rounded-lg h-12 w-full bg-blue-700 text-white font-bold hover:bg-blue-800 transition">
                            Iniciar sesión
                        </button>
                    </form>
